...
def load_config() -> dict:
    ...
    Reads ~/.config/codex-seo/google-api.json first, with a read-only fallback
    to a legacy Claude SEO config. Any missing fields use environment variables.
    ...
    # Prefer the Codex config while keeping upgrades from Claude SEO seamless.
...
def _persist_oauth_client_path(creds_path: str):
    ...
    config = {}
    source_path = _first_existing_path(CONFIG_PATH, LEGACY_CONFIG_PATH)
