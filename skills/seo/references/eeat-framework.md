...
## Experience (codex-seo internal scoring weight: 20%)
...
## Expertise (codex-seo internal scoring weight: 25%)
...
## Authoritativeness (codex-seo internal scoring weight: 25%)
...
## Trustworthiness (codex-seo internal scoring weight: 30%)
