...
This is the canonical methodology codex-seo uses to assemble raw findings
...
- Surface what codex-seo itself **could not measure** (offline
...
These principles are codex-seo's; they are not the user's. Surface them
for the user when:
