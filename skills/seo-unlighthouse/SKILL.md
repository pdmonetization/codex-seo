...
Use `.seo-cache/site-meta.json` for crawl context and write the aggregate run
to `.seo-cache/unlighthouse.json`. A cached local Lighthouse run is lab data,
not a replacement for current CrUX field data.
